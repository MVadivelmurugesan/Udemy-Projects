...
import clockimg from '@salesforce/resourceUrl/Alarmclock';
import ring from '@salesforce/resourceUrl/ringtone';

export default class UdAlarmClock extends LightningElement {
    clockImage = clockimg
    ringtone = new Audio(ring)
    currentTime = ''
    hours =[]
    minutes = []
    meridiems =['AM', 'PM']
